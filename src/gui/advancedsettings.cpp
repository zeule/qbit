...
void AdvancedSettings::saveAdvancedSettings()
{
    ...
    session->setSaveResumeDataInterval(boost::numeric_cast<uint>(spinBoxSaveResumeDataInterval.value()));
    // Outgoing ports
    ...
    session->setRefreshInterval(boost::numeric_cast<uint>(spinBoxListRefresh.value()));
    // Peer resolution
...
void AdvancedSettings::loadAdvancedSettings()
{
    ...
    spinBoxSaveResumeDataInterval.setValue(boost::numeric_cast<int>(session->saveResumeDataInterval()));
    ...
    spinBoxListRefresh.setValue(boost::numeric_cast<int>(session->refreshInterval()));
