...
void AdvancedSettings::saveAdvancedSettings()
{
    ...
    session->setSaveResumeDataInterval(boost::numeric_cast<uint>(m_spinBoxSaveResumeDataInterval.value()));
    // Outgoing ports
    ...
    session->setRefreshInterval(boost::numeric_cast<uint>(m_spinBoxListRefresh.value()));
    // Peer resolution
...
void AdvancedSettings::loadAdvancedSettings()
{
    ...
    m_spinBoxSaveResumeDataInterval.setValue(boost::numeric_cast<int>(session->saveResumeDataInterval()));
    ...
    m_spinBoxListRefresh.setValue(boost::numeric_cast<int>(session->refreshInterval()));
