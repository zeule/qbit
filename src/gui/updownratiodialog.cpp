...
UpDownRatioDialog::UpDownRatioDialog(bool useDefault, qreal initialRatioValue, qreal maxRatioValue,
            std::chrono::minutes initialTimeValue, std::chrono::minutes maxTimeValue, QWidget *parent)
    : QDialog(parent)
