...
namespace
{
    Theme::ColorTheme::Element toThemeElement(Theme::DownloadProgressBarElement element)
    {
        ...
        case Theme::DownloadProgressBarElement::Background:
            return Theme::ColorTheme::Element::DownloadProgressBar_Background;
        case Theme::DownloadProgressBarElement::Border:
            return Theme::ColorTheme::Element::DownloadProgressBar_Border;
        case Theme::DownloadProgressBarElement::Complete:
            return Theme::ColorTheme::Element::DownloadProgressBar_Complete;
        case Theme::DownloadProgressBarElement::Incomplete:
            return Theme::ColorTheme::Element::DownloadProgressBar_Incomplete;
        default:
    ...
    Theme::ColorTheme::Element toThemeElement(Log::MsgType messageType)
    {
        ...
        case Log::MsgType::ALL:
            return Theme::ColorTheme::Element::LogMessageType_ALL;
        case Log::MsgType::NORMAL:
            return Theme::ColorTheme::Element::LogMessageType_NORMAL;
        case Log::MsgType::INFO:
            return Theme::ColorTheme::Element::LogMessageType_INFO;
        case Log::MsgType::WARNING:
            return Theme::ColorTheme::Element::LogMessageType_WARNING;
        case Log::MsgType::CRITICAL:
            return Theme::ColorTheme::Element::LogMessageType_CRITICAL;
        default:
