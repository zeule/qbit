    ...
    public:
        ...
        */
        enum class Element
        {
            ...
            LogMessageType_ALL,
            LogMessageType_NORMAL,
            LogMessageType_INFO,
            LogMessageType_WARNING,
            LogMessageType_CRITICAL,

            DownloadProgressBar_Background,
            DownloadProgressBar_Border,
            DownloadProgressBar_Complete,
            DownloadProgressBar_Incomplete
        };
